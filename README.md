...
--- | ---  | ---  |
[Exploratory Data Analysis in Pandas][1-1E]     | Unit 2 | Session 4 |
[Experiments & Hypothesis Testing][1-1F]        | Unit 2 | Session 5 |
[Data Visualization in Python][1-1G]            | Unit 2 | Session 6 |
[Statistics in Python][1-1H]                    | Unit 2 | Session 7 |
[Assessing Performance][1-1I]                   | Unit 2 | Session 8 |
--- | ---  | ---  |
[Linear Regression][1-1J]                       | Unit 3 | Session 9 |
[Train-Test Split & Bias-Variance][1-1K]        | Unit 3 | Session 10 |
[KNN / Classification][1-1L]                    | Unit 3 | Session 11 |
...
[Deploying Models with Flask][2-1D]                 | Unit 4 | Session 19 |
...
[1-1I]: ./lessons/optional/assessing-performance/
...
[2-1E]: ./lessons/optional/svm/
[2-1F]: ./lessons/optional/dim-reduction/
...
We'll use Slack for our class communications platform. Slack is a messaging platform where you can chat with your peers and instructors. We will use Slack to share information about the course, discuss lessons, and submit projects. Our Slack homepage is [here](ga-nyc-ptstudents.slack.com). The channgle for this class is `#dat-12-10-2019`.
...
* Instructor's Office Hours - Saturday, 10AM - 12PM (or by Appointment)

Slack me to reserve a time-slot!
...
[Insert specific VTS/Exit Ticket details here.](https://docs.google.com/forms/d/10MEIEAR6ORf6oDVR68SUdcuu7pXoDyPUuATr7tXx60k)
